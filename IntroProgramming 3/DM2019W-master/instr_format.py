...
class Instruction(object):
    ...
    def encode(self) -> int:
        ...
        res = reserved.insert(1,0)
        instr = instr_field.insert(self.op.value, res)
        con = cond_field.insert(self.cond.value, instr)
        reg = reg_target_field.insert(self.reg_target,con)
        src1 = reg_src1_field.insert(self.reg_src1,reg)
        src2 = reg_src2_field.insert(self.reg_src2, src1)
        offset = offset_field.insert(self.offset, src2)
        return(offset)
